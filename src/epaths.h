...
*/
#define PATH_LOADSEARCH "/usr/local/share/emacs/24.3.92/lisp"
...
*/
#define PATH_SITELOADSEARCH "/usr/local/share/emacs/24.3.92/site-lisp:/usr/local/share/emacs/site-lisp"
...
*/
#define PATH_DUMPLOADSEARCH "/Users/capitaomorte/Source/Emacs/emacs-mac-port-manual/emacs-24.3.92/lisp"
...
#define PATH_EXEC "/usr/local/libexec/emacs/24.3.92/x86_64-apple-darwin13.3.0"

/* Where Emacs should look for its architecture-independent data
   files, like the NEWS file.  The lisp variable data-directory
   is set to this value.  */
#define PATH_DATA "/usr/local/share/emacs/24.3.92/etc"
...
#define PATH_DOC "/usr/local/share/emacs/24.3.92/etc"
